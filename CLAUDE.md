...
- Docker images: `registry.ahkc.win/<owner>/blob-indexer-api-api`, `registry.ahkc.win/<owner>/blob-indexer-api-indexer`
- Helm charts: `oci://registry.ahkc.win/<owner>/charts/blob-indexer`
