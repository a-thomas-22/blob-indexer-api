...
4. App releases publish Docker images to Harbor at `registry.ahkc.win/a-thomas-22/blob-indexer-api-api` and `registry.ahkc.win/a-thomas-22/blob-indexer-api-indexer`; chart releases package and push the Helm chart to `oci://registry.ahkc.win/a-thomas-22/charts`
