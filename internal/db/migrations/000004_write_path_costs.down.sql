...
-- Restore the 000003 end-state indexes this migration's up dropped. The
-- confirmed-keyed variants belong to 000003's down, not here.
...
CREATE INDEX IF NOT EXISTS idx_blobs_chain_block ON blobs(chain_id, block_number DESC);
