...
test-integration: swagger
	$(GOTEST) -tags integration -count=1 -v ./internal/db/... ./internal/indexer/... ./internal/api/... ./internal/attribution/...
...
chart-template-test:
	...
	bash charts/blob-indexer/tests/indexer-config-template-test.sh
